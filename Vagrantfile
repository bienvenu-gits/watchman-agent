...
#       agent.vm.box = "generic/windows10"
#       agent.vm.network "public_network"
# #       agent.vm.communicator = "winrm"
#       agent.winrm.username = "vagrant"
#       agent.winrm.password = "vagrant"
#       agent.winrm.basic_auth_only = true
#       agent.vm.boot_timeout = 360
#
#       # Provisioning script pour configurer SNMP
#       agent.vm.provision "shell", inline: <<-SHELL
#             # Installer le service SNMP
#             Get-WindowsFeature SNMP* || Install-WindowsFeature SNMP-Service
#
#             # Configurer le service SNMP
#             New-ItemProperty -Path "HKLM:\\SYSTEM\\CurrentControlSet\\services\\SNMP\\Parameters\\RFC1156Agent" -Name "sysContact" -Value "Contact" -PropertyType REG_SZ
#             New-ItemProperty -Path "HKLM:\\SYSTEM\\CurrentControlSet\\services\\SNMP\\Parameters\\RFC1156Agent" -Name "sysLocation" -Value "Location" -PropertyType REG_SZ
#
